...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>
                    开发者列表 <i class="fa fa-user"></i><small>${userSession.userName}
                    - 您可以通过搜索开发者用户名查询开发者并对开发者进行管理。^_^</small>
                </h2>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                        ...
                        <li>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input name="devName" type="text" class="form-control col-md-7 col-xs-12"
                                           value="${param.devName}">
                                </div>
                            </div>
                        </li>
                            ...
                            <table id="datatable-responsive"
                                ...
                                <c:forEach var="devInfo" items="${devInfoList }" varStatus="status">
                                    <tr role="row" class="odd">
                                        ...
                                        <td><a href="javascript:show(${devInfo.id })">点击查看简介</a></td>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li><a class="deleteDev"
                                                           devinfoid="${devInfo.id }" 
                                                           devcode ="${devInfo.devCode }"
                                                           data-toggle="tooltip" data-placement="top" title=""
                                                           data-original-title="删除开发者信息">删除</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
