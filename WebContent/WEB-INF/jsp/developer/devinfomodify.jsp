...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			<div class="x_title">
				<h2>
					修改开发者基础信息 <i class="fa fa-user"></i><small>${devUserSession.devName}</small>
				</h2>
				<div class="clearfix"></div>
			</div>
			<div class="x_content">
				<form id="form" class="form-horizontal form-label-left"
					action="infoupdate" method="post" enctype="multipart/form-data">
					...
					<div class="item form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input id="devCode" type="text"
								class="form-control col-md-7 col-xs-12" name="devCode"
					...
					<div class="item form-group">
						<label class="control-label col-md-3 col-sm-3 col-xs-12"
							for="name">电子邮箱 <span class="required">*</span>
						</label>
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input id="devEmail" class="form-control col-md-7 col-xs-12"
								data-validate-length-range="20" data-validate-words="1"
								required="required" name="devEmail" value="${devUser.devEmail}"
								placeholder="请输入电子邮箱" type="text">
						</div>
					</div>
					<div class="item form-group">
						<label class="control-label col-md-3 col-sm-3 col-xs-12"
							for="name">简介<span class="required">*</span>
						</label>
						<div class="col-md-6 col-sm-6 col-xs-12">
							<!-- 加载编辑器的容器 -->
							<script id="container" name="devInfo" type="text/plain">${devUser.devInfo}</script>
						</div>
					</div>
...
function show(pid){
        $.ajax({
            url: "getproductbypid.do?pid="+pid,
            async: false,
            type: "post",
            dataType: "json",
            success: function (data) {
                $('.modal-body').html(data.product.pdetail);
            }
        });
        $('#myModal').modal('show');
    }
<script
	src="${pageContext.request.contextPath }/statics/localjs/devinfomodify.js"></script>