...
<script type="text/javascript"
	src="${ pageContext.request.contextPath}/plugins/ueditor/ueditor.config.js"></script>
<!-- 编辑器源码文件 -->
<script type="text/javascript"
	src="${ pageContext.request.contextPath}/plugins/ueditor/ueditor.all.js"></script>
							...
							<ul class="nav side-menu">
								<li><a><i class="fa fa-home"></i> APP账户管理 <span
									...
									<ul class="nav child_menu">
										...
										<li><a
											href="${pageContext.request.contextPath }/dev/modify">个人账户信息维护</a>
										</li>
									</ul></li>
